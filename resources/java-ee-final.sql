...
--
-- Client :  127.0.0.1
-- Généré le :  Sam 09 Juin 2018 à 13:30
...
(9, 'TestWithMDP', 'TestWithMDP', '2018-06-09 00:00:00', '2018-12-09 00:00:00'),
(10, 'TestWithCaptcha', 'TestWithCaptcha', '2018-06-09 00:00:00', '2018-12-09 00:00:00'),
(11, 'TestWithMaxClick', 'TestWithMaxClick', '2018-06-09 00:00:00', '2018-12-09 00:00:00'),
(12, 'TestDateRange', 'TestDateRange', '2018-06-09 00:00:00', '2018-12-09 00:00:00'),
(13, 'TestDateMax', 'TestDateMax', '2018-06-09 00:00:00', '2018-12-09 00:00:00');
...
--
-- Contenu de la table `url_pass_option`
--

INSERT INTO `url_pass_option` (`url_complex_id`, `libelle`, `end_date`, `start_date`, `max_click`) VALUES
(3, 'captcha', NULL, NULL, NULL),
(4, 'click', NULL, NULL, 100),
(5, 'daterange', '2018-06-11', '2018-06-09', NULL),
(6, 'datemax', '2018-06-09', '2018-06-30', NULL);
